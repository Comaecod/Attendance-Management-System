...
public class ProfileActivityAdmin extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        profilePic.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (user.isEmailVerified())
                    ...
                    Toast.makeText(getApplicationContext(), "Admin! Please verify your email first!", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        findViewById(R.id.nextEmailReg).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                FirebaseUser user = mAuth.getCurrentUser();
                if (user.isEmailVerified()) {
    ...
    private void loadUserInfo() {
        ...
        if (user != null) {
            ...
            if (user.isEmailVerified()) {
                verify.setText("Email Verified! Admin! ");
            } else {
                verify.setText("Email Not Verified! Click To Verify! Admin!");
                    ...
                    public void onClick(View view) {
                        user.sendEmailVerification().addOnCompleteListener(new OnCompleteListener<Void>() {
                            ...
                            public void onComplete(@NonNull Task<Void> task) {
                                Toast.makeText(getApplicationContext(), "Verification Link Has Been Sent To Your Email Id! Admin!", Toast.LENGTH_SHORT).show();
