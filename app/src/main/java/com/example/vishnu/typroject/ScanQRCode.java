...
public class ScanQRCode extends AppCompatActivity implements ZXingScannerView.ResultHandler {
    ...
    public void handleResult(Result result) {
        ...
        if (URLUtil.isHttpsUrl(myResult)) {
            ...
            builder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
                @Override
                public void onClick(DialogInterface dialog, int which) {
                    scannerView.resumeCameraPreview(ScanQRCode.this);
                }
            });
            ...
            Intent i = new Intent(ScanQRCode.this, DisplayQROutput.class);

            i.putExtra("QRValue", myResult);
            startActivity(i);
        }
    }
}